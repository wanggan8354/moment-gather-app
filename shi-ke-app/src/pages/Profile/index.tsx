        ...
        <div className="relative pt-12 pb-6 px-5 overflow-hidden">
          <div
            ...
            style={{
              ...
              height: 200,
              background:
                "radial-gradient(ellipse, rgba(212, 132, 90, 0.12) 0%, transparent 70%)",
            }}
          />
          ...
          <div className="flex flex-col items-center relative z-10">
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, #C9A96E, #D4845A, #D4847A, #C9A96E)",
                padding: 3,
                borderRadius: "9999px",
                display: "inline-flex",
              }}
            >
              <div
                ...
                style={{
                  ...
                  borderRadius: "9999px",
                  background:
                    "linear-gradient(135deg, var(--color-primary-light), var(--color-film-rose))",
                  fontSize: "2rem",
                  fontFamily: "var(--font-display)",
                  ...
                  {idx < 2 && (
                    <div
                      ...
                      style={{
                        ...
                        height: 32,
                        background:
                          "linear-gradient(to bottom, transparent, #E8DDD2, transparent)",
                      }}
                    />
                  )}
                </div>
              ...
              >
                <div className="relative" style={{ height: 100 }}>
                  ...
                  <div
                    ...
                    style={{ background: "rgba(45,31,20,0.3)" }}
                  >
                    <div
                    ...
                    >
                      <Play
                        size={14}
                        style={{ color: "var(--color-primary)", marginLeft: 1 }}
